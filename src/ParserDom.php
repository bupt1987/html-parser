...
class ParserDom implements ParserInterface {
	 ...
	 * @return bool
	 */
	private function search(\DOMNode &$search, $idx, $selectors, $level, $search_levle = 0) {
	 ...
	 */
	private function seek(\DOMNode $search, $selectors, $current) {
	 ...
	 * @return \DOMNode
	 */
	private function getParent(\DOMNode $node) {
